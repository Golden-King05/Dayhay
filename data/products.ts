...
const rawProducts = [
  ...
  // ── Smelter ────────────────────────────────────────────────────────────────
  {
    ...
    levelRequired: 0,
    ingredients: [
      { itemId: 'coal', itemName: 'Coal', quantity: 3, icon: '⚫' },
    ],
  },
  {
    id: 'iron_bar',
    ...
    levelRequired: 0,
    ingredients: [
      { itemId: 'iron_ore', itemName: 'Iron Ore', quantity: 3, icon: '🪨' },
    ],
  },
  {
    id: 'silver_bar',
    ...
    levelRequired: 0,
    ingredients: [
      { itemId: 'silver_ore', itemName: 'Silver Ore', quantity: 3, icon: '🩶' },
    ],
  },
  {
    id: 'gold_bar',
    ...
    levelRequired: 0,
    ingredients: [
      { itemId: 'gold_ore', itemName: 'Gold Ore', quantity: 3, icon: '🪙' },
    ],
  },
  {
    id: 'platinum_bar',
    ...
    quantityPerRun: 1,
    ingredients: [
      { itemId: 'platinum_ore', itemName: 'Platinum Ore', quantity: 3, icon: '💿' },
    ],
  },
  // ── Jeweler ────────────────────────────────────────────────────────────────
  {
    ...
    quantityPerRun: 1,
    ingredients: [
      { itemId: 'iron_bar', itemName: 'Iron Bar', quantity: 2, icon: '🔩' },
      { itemId: 'silver_bar', itemName: 'Silver Bar', quantity: 1, icon: '🥈' },
    ],
  },
  {
    id: 'bracelet',
    ...
    quantityPerRun: 1,
    ingredients: [
      { itemId: 'silver_bar', itemName: 'Silver Bar', quantity: 2, icon: '🥈' },
      { itemId: 'gold_bar', itemName: 'Gold Bar', quantity: 1, icon: '🥇' },
    ],
  },
  {
    id: 'necklace',
    ...
    ingredients: [
      { itemId: 'silver_bar', itemName: 'Silver Bar', quantity: 2, icon: '🥈' },
      { itemId: 'gold_bar', itemName: 'Gold Bar', quantity: 1, icon: '🥇' },
      { itemId: 'platinum_bar', itemName: 'Platinum Bar', quantity: 1, icon: '💿' },
    ],
  },
  {
    id: 'diamond_ring',
    ...
    levelRequired: 0,
    ingredients: [
      { itemId: 'gold_bar', itemName: 'Gold Bar', quantity: 2, icon: '🥇' },
      { itemId: 'platinum_bar', itemName: 'Platinum Bar', quantity: 1, icon: '💿' },
